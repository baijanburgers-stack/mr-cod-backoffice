...
export default function StoreAdminLayout({ children, params }: { children: React.ReactNode, params: Promise<{ storeId: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Sidebar */}
      <motion.aside
        className={`fixed top-0 left-0 z-50 h-screen w-72 bg-white border-r border-slate-200 text-slate-900 flex flex-col transition-transform duration-300 ease-in-out ${
